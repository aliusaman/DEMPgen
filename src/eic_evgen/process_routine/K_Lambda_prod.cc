...
KLambda_Production::KLambda_Production() { 
...
KLambda_Production::KLambda_Production(TString particle_str) { 
...
void KLambda_Production::process_reaction() {
 
  Init();

  KLambda_Pythia6_Out_Init();
...
void KLambda_Production::Processing_Event() {
...
void KLambda_Production::Progress_Report() {
...
TLorentzVector KLambda_Production::GetProtonVector_lab() {
...
void KLambda_Production::Consider_Proton_Fermi_Momentum() {
...
TLorentzVector KLambda_Production::GetElectronVector_lab() {
...
void KLambda_Production::Lund_Output() {
...
void KLambda_Production::Detail_Output() {
...
Double_t KLambda_Production::Get_Phi_X_LeptonPlane_RF () {
...
Double_t KLambda_Production::Get_Phi_TargPol_LeptonPlane_RF () {
...
Double_t KLambda_Production::Get_Total_Cross_Section() {
  ...
  case KPlus:         total_sig = GetKPlus_CrossSection();
...
//Double_t KLambda_Production::GetKPlus_CrossSection() {
...
Double_t  KLambda_Production::GetKPlus_CrossSection(){
  ...
  fSig_VR = (0.1* fSig_T) + fEpsilon * (0.1* fSig_L);
  sig_total = fSig_VR;
...
void KLambda_Production::KLambda_Pythia6_Out_Init() {
...
void KLambda_Production::KLambda_Pythia6_Output() {
